...
import numpy as np
from .src import facenet as facenet
from .src.align import detect_face as detect_face
import random
...
def align_raw_images(input_dir=input_dir, output_dir=output_dir, image_size=182, margin=44,
    ...
    threshold = [ 0.6, 0.7, 0.7 ] # three step's thershold
    factor = 0.709 # scale factor

    # Add a random key to the filenmae to allow alignment using multiple processes
